    ...
    init: function() {
        ...
        if (md5($("#passwordLogin").val()) !== currentUser.password[1] && currentUser.password[0] && "" !== currentUser.password[1]) {
            ...
            $("#managedInstall").on("click", function(e) {
                e.preventDefault();
                window.location.href = "https://blocksi.net/bm-home.php";
            });
            $("#schoolManagedInstall").on("click", function(e) {
                console.log("test");
                e.preventDefault();
                window.location.href = "https://blocksi.net/chromebook-filtering.php";
            });
